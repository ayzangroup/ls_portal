...
// Route::get('facebook/{refer_code}', 'UserController@facebook')->name('facebook');

// Route::get('twitter/{refer_code}', 'UserController@twitter')->name('twitter');

Route::get('gplus/{refer_code}', 'UserController@gplus')->name('gplus');

// Route::get('linkedin/{refer_code}', 'UserController@linkedin')->name('linkedin');
