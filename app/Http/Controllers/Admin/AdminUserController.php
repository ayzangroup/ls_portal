...
{   
    ...
    public function dashboard(){
        ...
        $data = ["userCount" => $this->endUser->countIndvUser(),"userCorpCount" => $this->corpUser->countCorpUser(),"orderCount" => $this->order->countOrderWithStatus(2),"driverCount" => $this->drivers->countAllDriver(),"laundrymanCount" => $this->laundryman->countAllLaundryMan()];
