...

{
		public function order_history_detail(Request $request)
		{
			...
			return view::make('user.order_history_detail',compact('order'));
		}
		public function cancel_order(Request $request)
		{
			...
			if($cancel)
			{
				return redirect::route('user.order_history')->with('error_code','3')->with('message','Your Order Cancel successfully!')->with('status','Cancel Status');
			}
			else
			{
				return redirect::route('user.order_history')->with('error_code','3')->with('message','Your Order Cancel Failed!')->with('status','Cancel Status');
			}
		}
		...
		public function update_repeatorder(Request $request)
		{
			...
			if($repeat)
			{
				return redirect::route('user.order_history')->with('error_code','3')->with('message','Your Order repeat successfully!')->with('status','Repeat Status');
			}
			else
			{
		...
		public function repeat_order(Request $request)
		{
			 ...
			 //dd($itemsArr);
			  ...
			  return view::make('user.repeat_order',compact('services','categories','price','categoryid','order','order_items','itemsArr'));
		...
		public function save_order(Request $request)
		{
			 ...
			 //dd($itemsArr);
			  ...
			  return view::make('user.save_order',compact('services','categories','price','categoryid','order','order_items','itemsArr'));
		...
		public function edit_item(Request $request)
		{
			 ...
			 //dd($itemsArr);
			  ...
			  return view::make('user.edit_item',compact('services','categories','price','categoryid','order','order_items','itemsArr'));
		...
		public function update_feedback(Request $request)
		{
			...
			if($insert)
			{
				return redirect::route('user.order_history')->with('error_code','3')->with('message','Your Order Feedback Submit Successfully!')->with('status','Feedback Status');
			}
			else
			{
				return redirect::route('user.order_history')->with('error_code','3')->with('message','Your Order Feedback failed!')->with('status','Feedback Status');	
			}
		}
		public function complaint()
		{
			return view::make('user.complaint');
		}
		public function update_complaint(Request $request)
		{
			...
			if($insert)
			{
				return redirect::route('user.order_history')->with('error_code','3')->with('message','Your Order Complaint Successfully!')->with('status','Complaint Status');
			}
			else
			{
				return redirect::route('user.order_history')->with('error_code','3')->with('message','Your Order Complaint failed!')->with('status','Complaint Failed');	
			}
		}
		...
		public function favorite(Request $request)
		{
			...
			if($fav)
			{
				return redirect::route('user.order_history')->with('error_code','3')->with('message','Your Order favorite successfully!')->with('status','Order Favorite');
			}
			else
			{
				return redirect::route('user.order_history')->with('error_code','3')->with('message','Your Order favorite failed!')->with('status','Order Favorite');
			}
		}
		...
		public function unfavorite(Request $request)
		{
			...
			if($fav)
			{
				return redirect::route('user.order_history')->with('error_code','3')->with('message','Your Order unfavorite successfully!')->with('status','Order UnFavorite');
			}
			else
			{
				return redirect::route('user.order_history')->with('error_code','3')->with('message','Your Order unfavorite failed!')->with('status','Order UnFavorite');
			}
		}		
