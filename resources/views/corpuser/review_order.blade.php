              ...
              <ol>
                  ...
                  <li class="green-steps">
                    ...
                    @endphp
                      ...
                      <a href="{{route('corpuser.schedule')}}">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <span aria-hidden="true">&times;</span>
                 ...
                 <form class="login_modal forgot_password" action="{{route('corpuser.update_service')}}" method="post">
              ...
              <div class="col-md-6 review-col">
                  ...
                  <div class="calculator-details-box review-dtls">
                    ...
                    <h4>Selected items <a href="{{route('corpuser.edit_item',$orderId)}}"><i class="fa fa-pencil"></i> </a></h4>
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-6 review-col-pickup">
                  ...
                  <div class="review-pickup-dtls">
                      ...
                      <h4>Scheduled Pickup <a href="{{route('corpuser.schedule')}}"><i class="fa fa-pencil"></i> </a></h4>
                ...
                <div class="col-md-6 review-col-delivery">
                  ...
                  <div class="review-pickup-dtls">
                      ...
                      <h4>Scheduled Delivery <a href="{{route('corpuser.schedule')}}"><i class="fa fa-pencil"></i> </a></h4>
              ...
              <div class="col-md-12">
                ...
                <div class="checkout-save-btn">
                        ...
                        <a href="{{route('corpuser.schedule')}}" class="readMore">Back</a>

                        <a href="{{route('corpuser.payments',$orderId)}}" class="readMore">Payment</a>
