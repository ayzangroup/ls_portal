              ...
              <div class="col-md-5">
                  ...
                  <div class="help-box">
                     ...
                     @endphp
                      ...
                      <form class="add_help" action="{{route('corpuser.update_complaint')}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="hidden" placeholder="User Name" name="user_id" value="{{ $user->corpCustId }}">    
                                  <input type="hidden" placeholder="User Type" name="user_type" value="{{ $user->userType }}">
                                  <input type="text" placeholder="Subject" name="subject">
                                  <input type="hidden" placeholder="message_type" name="message_type" value="complaint">
                              </div>
