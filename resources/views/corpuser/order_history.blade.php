          ...
          <div class="row">
              ...
              <div class="col-md-12">
                  ...
                  <div class="tab-content">
                     ...
                     <div id="openorders" class="tab-pane fade in active">
                                ...
                                <div class="placed-order-details">
                                    ...
                                    <div class="placed-order-top-head">
                                        ...
                                        <div class="placed-order-top-head-rt">
                                            ...
                                            <span class="product-label"><a href="{{route('corpuser.order_history_detail',$orders->orderId)}}">View order details</a></span>
                                ...
                                <div class="package-details">
                                      ...
                                      <div class="col-lg-4 col-md-4">
                                          ...
                                          <div class="package-details-lt">
                                              ...
                                              <a href="{{route('corpuser.track',$orders->orderId)}}" class="btn btn-default">Track Laundry </a>

                                              <a href="{{route('corpuser.complaint')}}" class="btn btn-default btn-border">File a Complaint</a>
    ...
    <div class="modal-dialog modal-sm" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               <form class="login_modal forgot_password" action="{{route('corpuser.cancel_order')}}" method="post">
                  ...
                  {{csrf_field()}}
                                ...
                                <div class="placed-order-details">
                                    ...
                                    <div class="placed-order-top-head">
                                        ...
                                        <div class="placed-order-top-head-rt">
                                            ...
                                            <span class="product-label"><a href="{{route('corpuser.order_history_detail',$past_orders->orderId)}}">View order details</a></span>
                                ...
                                <div class="package-details">
                                      ...
                                      <div class="col-lg-4 col-md-4">
                                          ...
                                          <div class="package-details-lt">
                                              ...
                                              <a href="{{route('corpuser.repeat_order',$past_orders->orderId)}}" class="btn btn-default btn-border">Repeat </a>

                                              <a href="{{route('corpuser.feedback')}}" class="btn btn-default btn-border">Leave feedback</a>

                                          @if($past_orders->isFavorite==1)
                                             <a href="{{route('corpuser.unfavorite',$past_orders->orderId)}}" class="readMore tooltipcustom" data-toggle="tooltip" data-placement="top" title="" data-original-title="" style="float:left">
                                              <i class="fa fa-heart"></i>
                                             </a>
                                          @else
                                             <a href="{{route('corpuser.favorite',$past_orders->orderId)}}" class="readMore tooltipcustom" data-toggle="tooltip" data-placement="top" title="" data-original-title="" style="float:left;background:#d2d6de;">
                                              <i class="fa fa-heart"></i>
                                             </a>
                                          @endif

                                              <a href="{{route('corpuser.complaint')}}" class="btn btn-default btn-border" style="float:right">File a Complaint</a>
                    ...
                    <div id="cancelorders" class="tab-pane fade">
                                ...
                                <div class="package-details">
                                      ...
                                      <div class="col-lg-4 col-md-4">
                                          ...
                                          <div class="package-details-lt">
                                              ...
                                              <a href="{{route('corpuser.repeat_order',$cancel_orders->orderId)}}" data-toggle="modal" class="btn btn-default btn-border">Repeat</a>
                  ...
                  <div id="saved-orders" class="tab-pane fade">
                                ...
                                <div class="placed-order-details">
                                    ...
                                    <div class="placed-order-top-head">
                                        ...
                                        <div class="placed-order-top-head-rt">
                                            ...
                                            <span class="product-label"><a href="{{route('corpuser.save_order',$save_orders->orderId)}}">View order details</a></span>
                                ...
                                <div class="package-details">
                                      ...
                                      <div class="col-lg-4 col-md-4">
                                          ...
                                          @if($save_orders->isFavorite==1)
                                             <a href="{{route('corpuser.unfavorite',$save_orders->orderId)}}" class="readMore tooltipcustom" data-toggle="tooltip" data-placement="top" title="" data-original-title="" style="float:left">
                                              <i class="fa fa-heart"></i>
                                             </a>
                                          @else
                                             <a href="{{route('corpuser.favorite',$save_orders->orderId)}}" class="readMore tooltipcustom" data-toggle="tooltip" data-placement="top" title="" data-original-title="" style="float:left;background:#d2d6de;">
                                              <i class="fa fa-heart"></i>
                                             </a>
                                          @endif
                                              <a href="{{route('corpuser.save_order',$save_orders->orderId)}}" data-toggle="modal" class="btn btn-default btn-border" style="float:right">Order Place</a>
