...
$notification_old=$corpuser->corpuserNotification_old;                
@endphp
                ...
                <div class="common-background manageAdress">
                    <div class="commonBox">
                        ...
                        <div class="addres-dtls-first">
                            <div class="profile-box">
                                ...
                                <div class="profile-text">
                                    <h4>{{ $corpuser->concernPerson }}</h4>
                                    <span class="ls-email">{{ $corpuser->corpoarateEmail }}</span>
                                </div>
                            </div><!-- profile-box -->
                        </div>
                        <!-- addres-dtls-first -->
                        ...
                        <div class="cards">
                            ...
                            <a href="{{route('corpuser.address')}}" class="add-address btn-default">Add Address</a>
                        </div>
                                ...
                                <div class="address-box edit-box" id="dafaultfirst">
                                    <div class="address-box-inner-warp">
                                        ...
                                        <div class="address-box-inner">
                                            <span>Name</span>
                                            <span class="dtls-address">{{ $corpuser->concernPerson }}</span>
                                        </div>
                                        <!-- address-box-inner -->

                                        <div class="address-box-inner">
                                            <span>Email</span>
                                            <span class="dtls-address">{{ $corpuser->corpoarateEmail }}</span>
                                        </div>
                                        <!-- address-box-inner -->
                                        ...
                                        <!-- address-box-inner -->
                                         ...
                                         <div class="address-box-inner">
                                            <ul>
                                                <li><a href="{{route('corpuser.edit_address',$details->uniqueId)}}">Edit</a></li>
                                                <li><a href="{{route('corpuser.delete_address',$details->uniqueId)}}">Delete</a></li>
                                            </ul>
                                        </div>
                                        <!-- address-box-inner -->
