    ...
    <section class="content container-fluid">
       ...
       <div class="box" style="border:none">
          ...
          <div class="box-content">
                    ...
                    <form class="form-horizontal driver-register" role="form" method="POST" action="{{ url('/driver/register') }}" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input id="name" type="text" class="form-control" name="driverName">
