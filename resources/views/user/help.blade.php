                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="hidden" placeholder="Name" name="name" value="{{ $user->indvCustName }}">    
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="hidden" placeholder="Email" name="email" value="{{ $user->indvCustEmail }}">    
                            ...
                            <div class="col-md-12">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="hidden" placeholder="Phone" name="phone" value="{{ $user->indvCustMobile }}">    
