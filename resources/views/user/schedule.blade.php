...
<section class="content container-fluid dashboard">
      ...
      <!-- page content starts here -->    
       ...
       <div class="common-background schedule-wrapper">
          ...
          <form class="form-horizontal add-schedule" action="{{route('user.add_schedule')}}" method="post">
            {{csrf_field()}}
            ...
            <div class="row">
                  ...
                  <div class="schedule-box">
                    ...
                    @else
                      ...
                      @if(((strlen($details->companyAddress1) >2) && (strlen( $details->companyAddress2) >2) && (strlen($details->state) >2) && (strlen($details->city) >2 ) ) != '')  
                        ...
                        @else
                          <input type="radio" name="pickup_address" id="{{($details->addressType)}}" @if($details->uniqueId == $order->pickid) checked @elseif(count($address)=='1') checked @endif  value="{{$details->uniqueId}}"  onclick="{{($details->addressType)}}click();"><!-- class="hide" -->
                ...
                <div class="col-md-4">
                  ...
                  <div class="schedule-box">
                    ...
                    <span class="alert" id="alert3" style="color:red"></span>
                      <div class="form-group">

                          <input type="text" class="form-control calendar" placeholder="MM/DD/YYYY"  name="deliverdate" value="{{$deliver_date}}" id="datepicker2" onblur="return checktime2()">
                ...
                <div class="col-md-8 btn-full">
                    ...
                    <div class="checkout-save-btn">
                        ...
                        <a href="{{route('user.edit_item',$orderId)}}" class="readMore">Back</a>
     ...
     <!-- add address Model -->
        ...
        <div class="modal fade" id="address{{$orderId[0]}}" tabindex="-1"  aria-hidden="true" role="basic">
                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <form  class="save_address" action="{{route('user.save_address')}}" method="post">
...
var pickerdate1 = new Date(datepicker1);
      ...
      if(pickertime > '07:00' && pickertime < '18:30')
      {
          ...
          if(strhours == '12')
          {
            var strTime = strhours + ':' + minutes + ' ' + pm1;
          }
          else
          {
          ...
          if(strendhours == '12')
          {
            var endTime = strendhours + ':' + endminutes + ' ' + pm1;
          }
          else
          {
          ...
          if(endhours == '12')
          {
             var deliverstrTime = endhours + ':' + minutes + ' ' + pm1;
          ...
          if(deliverendhours == '12')
          {
            var deliverendTime = deliverendhours + ':' + endminutes + ' ' + pm1;
...
<script>
            ...
            $('.add-schedule').click(function(e){
                ...
                if($('input[name="deliver_address"]').length > 0 ){
                  document.getElementById("alert").innerHTML = "";
                }
                else 
                {
                     document.getElementById("alert").innerHTML = "Please choose the address";
...
function checktime()
{
    ...
    var pickend6 = moment(pickend1, ["h A"]).format("HH");
    var pickend7 = moment(pickend1, [":mm A"]).format(":mm");
   

    var y = 2;
    var x = Number(pickend6);
    var pickend8 = x + y;
    

    newtime1 = pickend8 + pickend6 ;

    document.getElementById("alert1").innerHTML = "";
    
    if (newtime1 > deliverstart1 || newtime1 == deliverstart1 &&  pickstart1!='Invalid date' &&  deliverstart1!='Invalid date'  )
    {
        document.getElementById("alert1").innerHTML = "Pick Up time will be less than 2hours of Deliver time";
        document.getElementById("alert2").innerHTML = "";
    }
    else if(pickend1=='Invalid date' || pickstart1=='Invalid date')
    {
        document.getElementById("alert1").innerHTML = "";
        document.getElementById("alert2").innerHTML = "";
    }
...
function checktime1()
{
    ...
    var pickend2 = document.getElementById("stepExample2").value;
    var pickend3 = moment(pickend2, ["h A"]).format("HH");
    var pickend5 = moment(pickend2, [":mm A"]).format(":mm");
   

    var y = 2;
    var x = Number(pickend3);
    var pickend4 = x + y;
    

    newtime = pickend4 + pickend5 ;
    ...
    if(deliverstart1 == newtime || deliverstart1 < newtime )
    {
       document.getElementById("alert2").innerHTML = "Deliver time will be greater than 2hours of pickup time";
       document.getElementById("alert1").innerHTML = "";
    }
    else if(deliverend1=='Invalid date' || deliverstart1=='Invalid date')
    {
        document.getElementById("alert2").innerHTML = "";
        document.getElementById("alert1").innerHTML = "";
    }
...
function checktime2()
{
    ...
    var d1 = new Date(datepicker1);
    var d2 = new Date(datepicker2);

    document.getElementById("alert3").innerHTML = "";
    
    if(d2 < d1)
    {
       document.getElementById("alert3").innerHTML = "Deliver date will be greater than pickup date";
    }
