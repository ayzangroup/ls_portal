        ...
        <div class="addres-dtls-first">
            ...
            <div class="profile-box">
                ...
                <div class="profile-text">
                    ...
                    <h4 class="data-edit">{{ $user->indvCustName }}
        ...
        <div class="clearfix"></div>
            ...
            <div class="data-section row" >
                ...
                <div class="col-sm-10">
                    ...
                    <span class="data-edit">{{ $user->indvCustEmail }}
                ...
                <div class="col-sm-10">
                    ...
                    <span class="data-edit">{{ $user->indvCustMobile }}
...
<!-- Edit Model -->
                                ...
                                <div class="modal fade" id="change_password" tabindex="-1"  aria-hidden="true" role="basic">
                                        ...
                                        <div class="modal-dialog modal-md">
                                            ...
                                            {{csrf_field() }}
                                                ...
                                                <input type="hidden" name="id" value="{{$user->indvCustId}}">
                                ...
                                <div class="modal fade" id="change_phone" tabindex="-1"  aria-hidden="true" role="basic">
                                        ...
                                        <div class="modal-dialog modal-sm">
                                            ...
                                            <form action="{{route('user.update_phone')}}"  method="post">
                                            ...
                                            {{csrf_field() }}
                                                ...
                                                <div class="modal-body"> 
                                                    ...
                                                    <input type="text" name="phone" class="form-control" value="{{ $user->indvCustMobile }}" required="required">
