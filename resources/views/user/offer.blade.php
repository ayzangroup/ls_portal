...
@section('content')
 <section class="content container-fluid dashboard">
      ...
      <div class="common-background">
          ...
          @if(in_array($user->indvCustId,$userId))

          <div class="offer-row">
            
            <div class="offer-card-wrapper">
              <div class="offer-card card">
                <img src="{{URL::asset('images/offers_images/'.$offer->offerImage)}}" alt="" class="img-responsive card-img-top w-100">
                <div class="card-body">
                  ...
                  <div class="min-max">
                    <p><b>Max. Discount:</b> {{$offer->discVal}} </p>
                    <p><b>Min. Order:</b> {{$offer->minOrderValue}} </p>
                  </div>
