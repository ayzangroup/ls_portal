      ...
      <!-- page content starts here -->    
       ...
       <div class="common-background price-calculator">
            ...
            <div class="cards common-card-head">
              ...
              <h2 class="heading">Please add items</h2>

            </div>
            
            <input type="hidden" name="service" checked value="{{$order->serviceId}}">
...
<script>
  $(document).ready(function(){
    $(document).on('click','.plus-minus-btn',function(e){
        ...
        $.ajax({
          url:path+"/user/update_item",
          method:"POST",
          data:{"_token":"{{ csrf_token() }}","codeValue":codeValue,"url1":url1},
        ...
        $(document).on('click','#orderSave',function(e){
         ...
         $(document).on('click','#orderSave12',function(e){
            var service = 0;
            var chk = false;
            if ($('input[name=service]')){
                service = $("input[name='service']").val();
