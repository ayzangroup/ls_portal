<link rel="stylesheet" href="{{URL::asset('bower_components/bootstrap/dist/css/bootstrap.min.css')}}">
  ...
  <link rel="stylesheet" type="text/css" href="{{URL::asset('dist/css//bootstrap-datepicker.min.css')}}">

  <link rel="stylesheet" type="text/css" href="{{URL::asset('dist/css/perfect-scrollbar.css')}}">

  <link rel="icon" href="{{URL::asset('dist/img/favicon.ico')}}" type="img/x-icon">
