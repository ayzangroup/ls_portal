    ...
    <section class="content container-fluid">
       ...
       <div class="box" style="border:none">
          ...
          <div class="box-content">
            ...
            <form class="form-horizontal add-serve"  method="post" action="{{url('/admin/register')}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="confirmed" id="confirmed" class="form-control" placeholder="Confirm Password">
