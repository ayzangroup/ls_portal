    ...
    <section class="content container-fluid">
       ...
       <!-- page content starts here -->     
        ...
        <div class="content-header content-header1">
           ...
           <h1 style="float:left;">View Why Us Data</h1>
           ...
           <span class="search-controls" style="float:right;">
             ...
             <a href="{{url('admin/add_whyus')}}" class="btn btn-default fill"> Add Data </a>  
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table   table-responsive no-padding video-list1">
                ...
                <tr>
                  ...
                  <td><img src="{{URL::asset('images/whyus_images/'.$d->image)}}" style="height:100px;width:75px;"></td>

                  <td>{{$d->description}}</td>

                  <td>

                    <a href="{{route('admin.edit_whyus',encrypt($d->id))}}" style="    margin-bottom: 10px;">
                                        ...
                                        <div class="modal-dialog modal-sm">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">Delete WhyUs</h4>

                                                </div>

                                            <form action="{{route('admin.delete_whyus')}}" method="post">

                                            {{csrf_field() }}

                                                <div class="modal-body"> Are you want delete the whyus. </div>
