    ...
    <section class="content container-fluid">
       ...
       <div class="box" style="border:none">
          ...
          <div class="box-content">
            ...
            <form class="form-horizontal edit-serve"  method="post" action="{{route('admin.update_serve')}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <img src="{{URL::asset('images/serve_images/'.$data->logo)}}" style="height:240px;width:210px">
