  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
        ...
        <div class="content-header content-header1">
           ...
           <h1 style="float:left;">View LaundryMan </h1>
           ...
           <span class="search-controls" style="float:right;">
             ...
             <a href="{{route('laundry.register')}}" class="btn btn-default fill"> Add Laundry </a>  
              ...
              <table id="example1" class="table   table-responsive no-padding video-list1">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="{{route('admin.laundry_profile',encrypt($d->laundryId))}}" style="margin-bottom:25px;">
                    ...
                    <a href="#" onclick="alertApprove<?php echo $i;?>(<?php echo $i;?>,{{ $d->laundryId }})" ><i class="fa fa-check"></i></a>

                    @else

                    <a href="#" onclick="alertApprove<?php echo $j;?>(<?php echo $k;?>,{{ $d->laundryId }})" ><i class="fa fa-close" style="color:red!important"></i></a>
...
<script>
            ...
            function alertApprove<?php echo $i;?>(index,user_id){
                ...
                swal({
                        ...
                        text: "You active the Laundry Man!",
                    ...
                    function(){
                        ...
                        $.ajax(

                            {
                                ...
                                url: APP_URL+"/admin/approve_laundry",
...
<script>
            ...
            function alertApprove<?php echo $j;?>(index,user_id){
                ...
                swal({
                        ...
                        text: "You In active The Laundry Man!",
