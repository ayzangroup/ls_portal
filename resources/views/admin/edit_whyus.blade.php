    ...
    <section class="content container-fluid">
       ...
       <div class="box" style="border:none">
          ...
          <div class="box-content">
            ...
            <form class="form-horizontal"  method="post" action="{{route('admin.update_whyus')}}" enctype="multipart/form-data">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="heading" style="height:150px;">{{$data->heading}}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <img src="{{URL::asset('images/whyus_images/'.$data->image)}}" style="height:240px;width:210px">
