    ...
    <section class="content container-fluid">
       ...
       <!-- page content starts here -->     
        ...
        <div class="content-header content-header1">
           ...
           <h1 style="float:left;">View Banner</h1>
           ...
           <span class="search-controls" style="float:right;">
             ...
             <a href="{{route('admin.add_banner')}}" class="btn btn-default fill"> Add Data </a>  
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table   table-responsive no-padding video-list1">
                ...
                <tr>
                  ...
                  <td><img src="{{URL::asset('images/banner_images/'.$d->image)}}" style="height:100px;width:75px;"></td>

                  <td>

                    <a href="{{route('admin.edit_banner',encrypt($d->id))}}" style="margin-bottom:25px;">
                ...
                <!-- Delete Model -->
                                ...
                                <div class="modal fade" id="delete{{ $d->id }}" tabindex="-1"  aria-hidden="true" role="basic">
                                        ...
                                        <div class="modal-dialog modal-sm">
                                            ...
                                            <form action="{{route('admin.delete_banner')}}" method="post">

                                            {{csrf_field() }}

                                                <div class="modal-body"> Are you want delete the banner. </div>
