    ...
    <section class="content container-fluid">
       ...
       <div class="box" style="border:none">
          ...
          <div class="box-content">
            ...
            <form class="form-horizontal edit-banner"  method="post" action="{{route('admin.update_banner')}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" style="height:150px;">{{$banner->description}}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <img src="{{URL::asset('images/banner_images/'.$banner->image)}}" style="height:240px;width:210px">
                ...
                <input type="hidden" name="image_old" value="{{$banner->image}}">
