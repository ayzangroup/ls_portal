    ...
    <section class="content container-fluid">
       ...
       <!-- page content starts here -->     
        <div class="content-header content-header1">
           <h1 style="float:left;">Laundry Profile</h1>
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="alert alert-info" style="background-color:#b2b8b9!important;border-color:#b2b8b9;">
                    <div class="row">
                        <label class="col-md-2">Laundry Name :</label>
                        <div class="col-md-4"> {{ucfirst($data->laundryName)}} </div>
                 ...
                 @if($data->licenseVerify=='0')
                        <span class="search-controls" style="float:right;">
                            <a href="#" class="btn btn-default1 fill" onclick="alertApprove<?php echo $i;?>(<?php echo $i;?>,{{ $data->laundryId }})"> Approve License Card </a>  
                        </span>
                ...
                @endif
                    ...
                    <div class="alert alert-warning" style="background-color:#d2d6de! important;border-color: #d2d6de">
                        ...
                        <a href="{{ URL::asset('images/laundrydocument_images/'.$data->licenseImage) }}" target="_blank"><img src="{{ URL::asset('images/laundrydocument_images/'.$data->licenseImage) }}" style="height:200px; width:200px;" alt="Pan Image"></a>
                    </div>
                    ...
                    <span class="search-controls" style="float:right;">
                            <a href="#" class="btn btn-default1 fill" onclick="alertApprove<?php echo $k;?>(<?php echo $k;?>,{{ $data->laundryId }})"> Approve Aadhar Card </a>  
                        </span>
                    ...
                    <div class="alert alert-warning" style="background-color:#9fb9d4! important;border-color: #9fb9d4">
                        <div class="row">
                            ...
                            <div class="col-md-4" style="text-align: center;">
                                <a href="{{ URL::asset('images/laundrydocument_images/'.$data->UIDImage) }}" target="_blank"> <img src="{{ URL::asset('images/laundrydocument_images/'.$data->UIDImage) }}" style="height:200px; width:200px;" alt="Aadher Image"></a>
                             </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
