    ...
    <section class="content container-fluid">
       ...
       <div class="box" style="border:none">
          ...
          <div class="box-content">
            ...
            <form class="form-horizontal add-coupoan"  method="post" action="{{route('admin.submit_coupoan')}}" enctype="multipart/form-data">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="codeType" >
                ...
                <div class="form-group">
                    ...
                    <div class="form-group demo-div mt20px">
                      ...
                      <input type="text" class="mt10px form-control" name="validFrom" id="J-demo-02" placeholder="MM/DD/YYYY"  style="background-color:#fff;">
                ...
                <div class="form-group">
                   ...
                   <div class="form-group demo-div mt20px">
                      ...
                      <input type="text" class="mt10px form-control" id="J-demo-01" placeholder="MM/DD/YYYY" name="validUpto" style="background-color:#fff;">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="couponCategory" >
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="useLimit" >
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="discVal" >
                     </div>
