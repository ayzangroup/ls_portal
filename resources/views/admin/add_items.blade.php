    ...
    <section class="content container-fluid">
       ...
       <div class="box" style="border:none">
          ...
          <div class="box-content">
            ...
            <form class="form-horizontal add-items"  method="post" action="{{route('admin.submit_items')}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group" style="margin-left:0px;">
                    ...
                    <select class="form-control select2 select2-hidden-accessible" name="packageId" style="width: 100%;" tabindex="-1" aria-hidden="true">
                      ...
                      <option value="{{$packaging->packagingId}}">{{$packaging->packagingName}}</option>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control mymce" name="itemDesc" style="height:150px;"></textarea>
