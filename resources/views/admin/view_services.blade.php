    ...
    <section class="content container-fluid">
       ...
       <!-- page content starts here -->     
        ...
        <div class="content-header content-header1">
           ...
           <h1 style="float:left;">View Services Management</h1>



           <span class="search-controls" style="float:right;">          

             <a href="{{route('admin.add_services')}}" class="btn btn-default fill"> Add Services </a>  
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table   table-responsive no-padding video-list1">
                ...
                <tr>
                  ...
                  <td><img src="{{URL::asset('images/services_images/'.$d->serviceImage)}}" style="height:100px;width:75px;"></td>

                  <td>{!! $d->serviceDescription !!}</td>

                  <td>

                    <a  href="{{route('admin.edit_services',encrypt($d->serviceId))}}">

                                                            <i class="fa fa-pencil"></i>

                    </a>

                    <a href="#delete{{$d->serviceId}}" data-toggle="modal"><i class="fa fa-trash"></i></a>
                ...
                <!-- Delete Model -->
                                ...
                                <div class="modal fade" id="delete{{ $d->serviceId }}" tabindex="-1"  aria-hidden="true" role="basic">
                                        ...
                                        <div class="modal-dialog modal-sm">
                                            ...
                                            <form action="{{route('admin.delete_services')}}" method="post">

                                            {{csrf_field() }}

                                                <div class="modal-body"> Are you want delete the service. </div>

                                                <input type="hidden" name="id" value="{{$d->serviceId}}">
