    ...
    <section class="content container-fluid">
       ...
       <!-- page content starts here -->     
        ...
        <div class="content-header content-header1">
           ...
           <h1 style="float:left;">View Serve</h1>
           ...
           <span class="search-controls" style="float:right;">
             ...
             <a href="{{url('admin/add_serve')}}" class="btn btn-default fill"> Add Data </a>  
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table   table-responsive no-padding video-list1">
                ...
                <tr>
                  ...
                  <td><img src="{{URL::asset('images/serve_images/'.$d->logo)}}" style="height:100px;width:75px;"></td>

                  <td>{{$d->description}}</td>

                  <td>

                    <a href="{{route('admin.edit_serve',encrypt($d->id))}}" style="    margin-bottom: 10px;">
                                        ...
                                        <div class="modal-dialog modal-sm">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">Delete serve</h4>

                                                </div>

                                            <form action="{{route('admin.delete_serve')}}" method="post">

                                            {{csrf_field() }}

                                                <div class="modal-body"> Are you want delete the serve. </div>
