    ...
    <section class="content container-fluid">
       ...
       <!-- page content starts here -->     
        ...
        <div class="content-header content-header1">
           ...
           <h1 style="float:left;">View Items Management</h1>



           <span class="search-controls" style="float:right;">          

             <a href="{{route('admin.add_items')}}" class="btn btn-default fill"> Add Items </a>  
              ...
              <table id="example1" class="table   table-responsive no-padding video-list1">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="{{route('admin.edit_items',encrypt($d->itemId))}}" style="margin-bottom:10px;"><i class="fa fa-pencil"></i>

                    </a>

                    <a href="#delete{{$d->itemId}}" data-toggle="modal"><i class="fa fa-trash"></i></a>
                ...
                <!-- Delete Model -->
                                ...
                                <div class="modal fade" id="delete{{ $d->itemId }}" tabindex="-1"  aria-hidden="true" role="basic">
                                        ...
                                        <div class="modal-dialog modal-sm">
                                            ...
                                            <form action="{{route('admin.delete_items')}}" method="post">

                                            {{csrf_field() }}

                                                <div class="modal-body"> Are you want delete the Item. </div>

                                                <input type="hidden" name="id" value="{{$d->itemId}}">
