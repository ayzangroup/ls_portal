          ...
          <div class="box-content">
            ...
            <div class="col-md-6">
                ...
                <div class="white-box">
                    ...
                    <form class="form-horizontal add-notification1"  method="post" action="{{route('admin.send_notification_user_submit')}}" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
                ...
                <div class="white-box">
                    ...
                    <h2>Send Notification to Corporate User</h2>

                </div>  

                    <form class="form-horizontal add-notification"  method="post" action="{{route('admin.send_notification_corpuser_submit')}}" enctype="multipart/form-data">
