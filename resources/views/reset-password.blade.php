...
<body>
    @php
    $userType=Request::segment(4);
    @endphp

    <div class="form-wrapper">

        <form class="form" id="frmReset" action="{{ URL::to('/') }}/api/{{ $userType }}/set-new-password" method="post">
            ...
            <div class="input-group mb-3">
                ...
                <div class="input-group-prepend">
                    ...
                    <input type="password" name="txtPassword" id="txtPassword" class="form-control" placeholder="New Password" aria-label="New Password" aria-describedby="basic-addon1" />
            ...
            <div class="input-group mb-3">
                ...
                <div class="input-group-prepend">
                    ...
                    <input type="password" name="txtCnfPassword" id="txtCnfPassword" class="form-control"  placeholder="Confirm New Password" aria-label="Confirm Password" aria-describedby="basic-addon1" />
            ...
            <div class="submit-btn">
                ...
                <input type="hidden" name="hdUserId" id="hdUserId" value="{{ $userId or 'empty string' }}" />

                <input type="hidden" name="hdUserType" id="hdUserType" value="{{ $userType or 'empty string' }}" />

                <!-- <button type="submit" id="reset" name='reset' value="submit" class="btn btn-primary">Reset</button> -->

                <a href="javascript:void(0);" id="resetBtn" name="resetBtn" class="btn btn-primary" onclick="javascript:return validationForm();">Reset</a>
