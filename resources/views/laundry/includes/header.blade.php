<!-- Main Header -->
  <header class="main-header">
   ...
   <!-- Logo -->
    <a href="{{ route('laundry.dashboard')}}" class="logo">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu header-user-profile">
            ...
            <ul class="dropdown-menu login-dropdown-menu">
              ...
              <li>
                <a href="{{ url('laundry/logout') }}" onclick="event.preventDefault(); document.getElementById('frm-logout').submit();">

                  <i class="fa fa-sign-out" aria-hidden="true"></i> Logout

                </a> 

                <form id="frm-logout" action="{{ route('laundry.logout') }}" method="POST" style="display: none;">
